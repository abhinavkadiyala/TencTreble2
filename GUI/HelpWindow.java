...
public class HelpWindow extends JFrame {
	...
	public HelpWindow() {
		...
		label4 = new JLabel("The goal of the game is to kill the other tank(s). The cross indicates where the bullet will spawn. (Yes, you can shoot across walls if you are close enough)");
